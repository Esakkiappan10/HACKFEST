...
const Footer = () => {
  return (
    <footer className="relative w-full bg-[#08123B] text-white font-[Fredoka] overflow-hidden">
      ...
      {/* Bottom Credit Line */}
      <div className="relative z-10 w-full border-t border-[#1E2A60] py-4 bg-[#08123B]/90 text-center text-gray-400 text-[13px] sm:text-[14px] font-[Poppins]">
        Designed & Developed by{" "}
        <a
          href="https://freewilltech.in"
          target="_blank"
          rel="noopener noreferrer"
          className="text-[#FFD400] hover:text-[#00A2FF] transition-colors duration-300 font-medium"
        >
